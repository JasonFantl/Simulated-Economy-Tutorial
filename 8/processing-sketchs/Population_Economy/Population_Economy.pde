...
void setup() {
  ...
  community = new Community(150.0, 200.0, 100.0);
  ...
  plot2.getYAxis().getAxisLabel().setText("Foxs");
  plot2.setXLim(0.0, 350);
  plot2.setYLim(0.0, 350);
}
...
void draw() {
  ...
  plot2.addPoint(community.populations.get("rabbits"), community.populations.get("foxs"));
